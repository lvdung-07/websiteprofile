...
document.addEventListener("DOMContentLoaded", function () {
  ...
  telegramDiv.addEventListener("click", function () {
    window.open("https://github.com/lvdung-07", "_blank");
  });
});
document.addEventListener("DOMContentLoaded", function () {
  var telegramDiv = document.querySelector(".Facebook");
  telegramDiv.addEventListener("click", function () {
    window.open("https://www.facebook.com/dung.luong.353351", "_blank");
  });
});
document.addEventListener("DOMContentLoaded", function () {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  telegramDiv.addEventListener("click", function () {
    window.open("https://www.tiktok.com/@lacloi018", "_blank");
  });
});
document.addEventListener("DOMContentLoaded", function () {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  telegramDiv.addEventListener("click", function () {
    window.open("https://zalo.me/0376283607", "_blank");
  });
});
